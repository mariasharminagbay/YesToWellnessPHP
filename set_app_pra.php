                        ...
                        <form name="f3" action="" method="POST">
                          <table>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="namePatient" id="namePatient" disabled>
                            </div>
                            <div class="form-group">
                                <label>Virtual Room Address</label>
                                <input type="text" name="virtualroom" id="virtualroom" disabled>
                            </div>
                            <div class="form-group">
                                <label name="notes" id="notes">Notes</label>
                                <!-- <input type="text" name="notes" id="notes" disabled> -->
                                <textarea form="f3.notes" rows=5 cols=70></textarea>
                            </div>
                            
                            <div class="form-group">
                                <input type="submit" name="save" value="Save" style="margin-left:auto; margin-right:auto;">
                            </div>
</table>
                        </form>
